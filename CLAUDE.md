...
- **golangci-lint v2.1.6** - Install with:
  ```bash
...
**Note**: The project uses golangci-lint v2.1.6 with 62 enabled linters. Always run linting locally before pushing to avoid CI failures.
