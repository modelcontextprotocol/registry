...
- [PrivacyScrubber MCP](https://github.com/moxno/privacyscrubber-mcp) - Zero-trust local MCP server that masks PII on the fly for Cursor, Claude, and AI workflows.
