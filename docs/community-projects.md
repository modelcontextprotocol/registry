...
- [RAGMap](https://ragmap-api.web.app) - RAG-focused subregistry + MCP server to discover retrieval-capable MCP servers; semantic search, filters, explainable ranking.
