...
// StorageInfo represents S3-compatible backup storage configuration
...
type ClusterProvider interface {
	...
	CreateBackupStorage(ctx *pulumi.Context, cluster *ProviderInfo, environment string) (*StorageInfo, error)
}